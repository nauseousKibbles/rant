...
class rantform(FlaskForm):
    password = TextAreaField('Password', validators=[DataRequired()], default="Password to delete or edit post.")
...
class deleteform(FlaskForm):
    password = TextField('Password', validators=[DataRequired()], default="ENTER PASSWORD TO DELETE")
